      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center md:items-end justify-between gap-8">
        <div className="flex flex-col items-center md:items-start gap-6">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-x-8 gap-y-2">
            <Link to="/community-guidelines" className="text-white/40 hover:text-primary transition-colors text-[10px] uppercase tracking-[0.2em] font-bold">{t('footer_guidelines')}</Link>
            <Link to="/terms-of-use" className="text-white/40 hover:text-primary transition-colors text-[10px] uppercase tracking-[0.2em] font-bold">{t('footer_terms')}</Link>
            <Link to="/privacy-policy" className="text-white/40 hover:text-primary transition-colors text-[10px] uppercase tracking-[0.2em] font-bold">{t('footer_privacy')}</Link>
          </div>
        </div>
